      ...
      case 'MENTOR':
        ...
        return {
          progressData: {
            ...
            data: [
              { title: "Active Projects", value: mentorProjects.filter(p => p.open_status === 'Open').length },
          ...
          pieChartData: {
            ...
            values: [
              mentorTasks.filter(t => t.complete_status === 'Completed').length,
              mentorTasks.filter(t => t.complete_status === 'Pending').length
            ],
