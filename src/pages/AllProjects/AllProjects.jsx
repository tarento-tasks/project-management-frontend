...
const AllProjects = () => {
  ...
  const inProgressProjects = projects.filter(p => p.projectStatus.toUpperCase() === "IN_PROGRESS");
  const toBeReviewedProjects = projects.filter(p => p.projectStatus.toUpperCase() === "TO_BE_REVIEWED");
  const completedProjects = projects.filter(p => p.projectStatus.toUpperCase() === "COMPLETED");
      ...
      <div className={styles.allprojectscontainer}>
        ...
        <div className={styles.kanbanBoard}>
          ...
          <div className={`${styles.column} ${styles.toBeReviewed}`}>
            ...
            {toBeReviewedProjects.map((project, index) => (
              <ProjectCard key={index} {...project} />
            ))}
          </div>
